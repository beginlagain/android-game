...
//player
        EntityBase{
            ...
            BoxCollider{
                 ...
                 fixture.onBeginContact: {
                     ...
                     if(collider.entityType==="enemy1"||collider.entityType==="enemy2"||collider.entityType==="enemy3"||collider.enetityType==="enemy4"){
                         playerlife--
                         psDuration=10000
        ...
        MouseArea{
            anchors.fill:scene
             drag.target: player
           // onPositionChanged:Controls.getPosition(player,mouse)
                /*{
                onPositionChanged:{
                    player.x=mouseX
                    player.y=mouseY
...
//enemy
        ...
        Component{
            ...
            EntityBase{
                ...
                BoxCollider{
                    property int enemy4Life:utils.generateRandomValueBetween(15,20)
